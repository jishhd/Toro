...
class NfcSender(private val activity: NfcActivity) : NfcAdapter.CreateNdefMessageCallback, NfcAdapter.OnNdefPushCompleteCallback {
    override fun createNdefMessage(event: NfcEvent): NdefMessage {
        ...
        val outString = Gson().toJson(activity.outcomingMessage)
